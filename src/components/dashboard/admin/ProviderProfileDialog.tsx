            ...
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="text-2xl flex items-center gap-2">
                        ...
                        {profile?.role === 'carrier' ? 'Carrier Profile' : 'Escort Profile'}
                    </DialogTitle>
                    <DialogDescription>
                            ...
                            <TabsContent value="fleet" className="pt-6">
                                {loadingSecondary ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {vehicles.map((v) => (
                                            <div key={v.id} className="p-4 border rounded-xl bg-card hover:shadow-sm transition-shadow">
                                                <div className="flex items-start justify-between">
                                                    <div>
                                                        <h5 className="font-bold text-lg">{v.name}</h5>
                                                        <p className="text-xs text-muted-foreground uppercase font-black">{v.type}</p>
                                                    </div>
